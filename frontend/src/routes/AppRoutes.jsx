  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        {/* Training Discovery is accessible to everyone (including guests) */}
        ...
        >
          ...
          <Route
            path="dashboard"
            element={
              <ProtectedRoute allowedRoles={[ROLES.NDMA_ADMIN]}>
                <Dashboard />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={[ROLES.NDMA_ADMIN, ROLES.TRAINING_PROVIDER]}>
                <TrainingForm />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={[ROLES.TRAINING_PROVIDER]}>
                <UploadEvidence />
              </ProtectedRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <ProtectedRoute allowedRoles={[ROLES.PUBLIC_USER]}>
                <MyRegistrations />
              </ProtectedRoute>
            }
          />
